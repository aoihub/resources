--[ Credits: https://raw.githubusercontent.com/xHeptc/NotificationGUI/main/source.lua ]--
...
-- thank you kesh for drag :) <3 (updated for Touch devices! by Aoi)
local function ApplyDrag(Component, MainWindow)
	...
	Component.InputBegan:Connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            ...
            -- Bind the release event directly to the input that started it
	...
	Component.InputChanged:Connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
			dragInput = input
		end
	end)

	inpService.InputChanged:Connect(function(input)
		if input == dragInput and dragging then
			...
			Tween(MainWindow, 0.1, {Position = ToBounds(targetX, targetY, MainWindow)})
		end
	end)
end
